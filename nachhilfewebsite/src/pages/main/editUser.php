                ...
                <div class="small-12 medium-6 columns">
                    <label>Vorname
                        <input <?php if (!Benutzer::get_logged_in_user()->has_permission("canEditName")) {
                            echo "readonly";
                        } ?> value="<?php echo $user->vorname ?>" name="vorname" type="text" placeholder="Max" required
                    ...
                    <label>Telefonnummer
                        <input value="<?php echo $user->telefonnummer ?>" pattern="^[0-9]{0,15}$" name="telefonnummer"
                               type="tel">
                        <span class="form-error">
                    ...
                    if (Benutzer::get_logged_in_user()->has_permission("editQuals") == true && Benutzer::get_by_id($user_to_edit_id)->has_permission("giveClasses")) {
                        ...
                        echo "<div class='small-10 centered columns data-label'>";
