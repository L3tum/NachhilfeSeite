...
$("#show_connections").on("click", function (ev) {
    ...
    runMyAjax("ajax/getConnectionsWithNames.php", function (result) {
        var html = "<table class='hover'><thead><tr><th>Lehrer</th><th>Schüler</th><th>Fach</th></tr></thead><tbody>";
...
$("#show_unpaid_hours").on("click", function (ev) {
    ...
    runMyAjax("ajax/getUnpaidHours.php", function (result) {
        var html = "<table id='unpaid_table'><thead><tr><th>Lehrer</th><th>Schüler</th><th>Datum</th><th>Zahlung(Lehrer)</th><th>Zahlung(Admin)</th></tr></thead><tbody>";
        result.data.forEach(function (data) {
...
$("#showAllTakenRooms").on("click", function(ev){
    ev.preventDefault();
    $("#results").empty();
});
