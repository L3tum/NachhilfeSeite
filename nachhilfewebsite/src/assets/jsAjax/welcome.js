...
if (years >= 1 && days == 0) {
    getScript("assets/jsAjax/oneyear.js").done(function () {
        ...
        $(document.body).append(`<div name="kill" class="error text-center" style="position:fixed; top:50%; left:45%;z-index:999;"><p>Anniversary! YAAAY!!!</p><p style="font-size: 10%">(press r to clear)</p></div>`);
...
if(years > 5){
    $(document.body).append("<div class='float-right'><p> Diese Seite läuft seit " + years + " Jahren!!!</p></div>")
}